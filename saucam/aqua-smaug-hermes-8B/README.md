# saucam/aqua-smaug-hermes-8B results

## openllm results 

 |Benchmark|                                  Model                                   |gsm8k| arc |hellaswag|mmlu |truthfulqa|winogrande|Average|
|---------|--------------------------------------------------------------------------|----:|----:|--------:|----:|---------:|---------:|------:|
|openllm  |[aqua-smaug-hermes-8B](https://huggingface.co/saucam/aqua-smaug-hermes-8B)|79.61|61.77|    82.25|64.96|     55.11|     76.09|  69.96|

### gsm8k
|Task |Version|              Metric               |Value|   |Stderr|
|-----|------:|-----------------------------------|-----|---|------|
|gsm8k|      3|exact_match,strict-match           | 0.80|   |      |
|     |       |exact_match_stderr,strict-match    | 0.01|   |      |
|     |       |exact_match,flexible-extract       | 0.80|   |      |
...
|     Task     |Version|        Metric         |      Value      |   |Stderr|
|--------------|-------|-----------------------|-----------------|---|------|
|truthfulqa    |N/A    |rougeL_max,none        |            41.88|   |      |
|              |       |rougeL_max_stderr,none |             0.85|   |      |
|              |       |rouge2_diff,none       |            -1.22|   |      |
|              |       |rouge2_diff_stderr,none|             0.94|   |      |
|              |       |bleu_max,none          |            20.71|   |      |
|              |       |bleu_max_stderr,none   |             0.74|   |      |
|              |       |rouge1_max,none        |            45.11|   |      |
|              |       |rouge1_max_stderr,none |             0.84|   |      |
|              |       |rougeL_acc,none        |             0.48|   |      |
|              |       |rougeL_acc_stderr,none |             0.02|   |      |
|              |       |rougeL_diff,none       |            -0.51|   |      |
|              |       |rougeL_diff_stderr,none|             0.81|   |      |
|              |       |bleu_diff,none         |            -0.14|   |      |
|              |       |bleu_diff_stderr,none  |             0.63|   |      |
|              |       |rouge2_max,none        |            30.32|   |      |
|              |       |rouge2_max_stderr,none |             0.95|   |      |
|              |       |bleu_acc,none          |             0.46|   |      |
...
|              |       |rouge1_diff,none       |            -0.35|   |      |
|              |       |rouge1_diff_stderr,none|             0.80|   |      |
|              |       |alias                  |truthfulqa       |   |      |
|truthfulqa_gen|      3|bleu_max,none          |            20.71|   |      |
|              |       |bleu_max_stderr,none   |             0.74|   |      |
|              |       |bleu_acc,none          |             0.46|   |      |
|              |       |bleu_acc_stderr,none   |             0.02|   |      |
|              |       |bleu_diff,none         |            -0.14|   |      |
...
|truthfulqa_mc1|      2|acc,none               |             0.39|   |      |
|              |       |acc_stderr,none        |             0.02|   |      |
|              |       |alias                  | - truthfulqa_mc1|   |      |
|truthfulqa_mc2|      2|acc,none               |             0.55|   |      |
|              |       |acc_stderr,none        |             0.02|   |      |
...
Metadata: {'elapsed_time': '02:32:14', 'gpu': 'NVIDIA A100 80GB PCIe'}
